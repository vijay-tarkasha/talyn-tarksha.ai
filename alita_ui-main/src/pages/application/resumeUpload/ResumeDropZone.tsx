...
const ResumeDropZone = ({ fileList, setFileList }: IInput) => {
          ...
          <div className="px-10 py-5">
            <div className="items-center justify-between md:flex">
              <div className="text-base md:text-2xl font-bold pb-2 md:pb-0">
                {applicationTexts.new.img.upload}
              </div>
            </div>
              ...
              >
                ...
                <div className="flex flex-col items-center text-center">
                  ...
                  <div className="text-xl font-semibold text-gray-700 mt-2 py-1">
                    {applicationTexts.new.img.drop}
                  </div>
                  <div className="text-sm font-semibold text-gray-500 mt-2 py-1">
                    {applicationTexts.new.img.format}
                  </div>
                  <div className="text-sm font-semibold text-gray-500 mt-2 py-1">
                    {applicationTexts.new.img.or}
                  </div>
                  <div
                  ...
                  >
                    {applicationTexts.new.img.browse}
                  </div>
                </div>
              </div>
            </section>
